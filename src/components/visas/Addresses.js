...
function Addresses() {
  ...
  return (
    <div className="general-container">
      {" "}
      <p className="App-text" style={{ top: "8vh" }}>
        Addresses
      </p>
